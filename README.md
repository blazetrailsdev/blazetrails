...
| ---------------------------- | ----------------------------------------------------------------------- | --------- | --------- | ---------------------------------------------------------- |
| `@blazetrails/activerecord`  | [ActiveRecord](https://api.rubyonrails.org/classes/ActiveRecord.html)   | **37.7%** | **61.9%** | ORM — persistence, querying, associations, migrations      |
| `@blazetrails/activesupport` | [ActiveSupport](https://api.rubyonrails.org/classes/ActiveSupport.html) | **24.2%** | **77.9%** | Core utilities, inflection, caching, notifications         |
| `@blazetrails/arel`          | [Arel](https://api.rubyonrails.org/classes/Arel.html)                   | **77.6%** | **99.4%** | SQL AST builder and query generation                       |
| `@blazetrails/activemodel`   | [ActiveModel](https://api.rubyonrails.org/classes/ActiveModel.html)     | **65.2%** | **100%**  | Attributes, validations, callbacks, dirty tracking, i18n   |
| `@blazetrails/rack`          | [Rack](https://rack.github.io/)                                         | —         | **100%**  | Modular web server interface, request/response, middleware |

**Data Layer Parity** (ActiveRecord + Arel + ActiveModel + ActiveSupport): **38.8% API** | **70.3% Tests**
...
| `@blazetrails/actioncontroller` | [ActionController](https://api.rubyonrails.org/classes/ActionController.html) | **46.8%** | **28.3%** | Controller layer, rendering, filters, parameters       |
...
**27.5%** overall API coverage (2,508 of 9,124 methods) | **50.9%** test coverage (11,140 of 21,890 tests). CI runs both comparisons on every push.
