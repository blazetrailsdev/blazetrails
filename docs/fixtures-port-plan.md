...
> **Status (2026-05-23):**
>
> **Fixtures port — complete.** All 122 Rails fixtures translated (PRs
> 0–6b + 0.5a–h + 0.75 + 4-late, merged 2026-05-20…21). `pnpm
fixtures:compare` passes hard-fail (PR 7). Proof-of-concept fixture
> consumption merged (PR 8 / #2318). Schema port live in
> `setup-adapter-suite.ts`.
>
