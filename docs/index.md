...
| [`join-dependency-arel-plan.md`](activerecord/join-dependency-arel-plan.md)                 | P2       | M    | Full Rails fidelity for JoinDependency. PRs 1–7b + F1 shipped; F2–F6 remain (~700 LOC across 3 core + 2 stretch PRs).                   |
