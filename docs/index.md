...
| [`actionpack-restructure-audit.md`](actionpack-restructure-audit.md)                     | P1       | L    | Directory-layout audit (~52% file coverage vs Rails). 6 mechanical-move waves + Wave 7 journey/ port (~7 PRs, ~1700 LOC) + Wave 8+ selective fill-in. `system_testing/` not ported.    |
