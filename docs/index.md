...
| [`actionpack-journey-port-plan.md`](actionpack-journey-port-plan.md)                     | P1       | L    | Wave 7 sizing audit: 14 Rails files (2062 LOC) → 10 PRs (L/S₁/S₂/V/P/G/R₁/R₂/R₃ + wire-up). LOC ceiling waived for mechanical ports.                                                            |
