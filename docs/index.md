...
| [`connection-pooled-test-adapter-plan.md`](connection-pooled-test-adapter-plan.md) | P1       | M    | Pool epic. Phase B/C shipped (#2242/#2245); D-X (PG+MySQL) closed; D-Y (#2372) shipped; D-1..N codemod sweep in flight; Phases E/F open.                                                                                                 |
...
| [`archive/fixtures-port-plan.md`](archive/fixtures-port-plan.md)                   | archived | —    | Closed. Models port + fixture YAML port complete (2026-05-23). Follow-up work in `fixtures-adoption-plan.md`.                                                                                                                            |
| [`archive/tm-unification-plan.md`](archive/tm-unification-plan.md)                 | archived | —    | Closed. Phases 1–9b shipped; 9b-3 closed misdesigned (#2189); 9b-4 absorbed into pool epic Phase F.                                                                                                                                      |
