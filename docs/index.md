...
| [`connection-pooled-test-adapter-plan.md`](connection-pooled-test-adapter-plan.md) | P0       | M    | Pool epic. Phase B/C shipped (#2242/#2245); Phase D sweep in flight; Phases E/F collapse with TM Phase 9b-4.                                                                                                                             |
...
| [`tm-unification-plan.md`](tm-unification-plan.md)                                 | P1       | M    | Route every adapter through `TransactionManager`. Phases 1–8 closed; 9a + 9b-1/9b-2a–e merged; 9b-3 blocked / needs re-eval; 9b-4 collapses with pool Phase F.                                                                           |
