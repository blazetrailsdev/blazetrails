...
export namespace CallTemplate {
  ...
  export const objectCall = ObjectCall;
  export const instanceExec0 = InstanceExec0;
  export const instanceExec1 = InstanceExec1;
  export const instanceExec2 = InstanceExec2;
